...
const partners: Partner[] = [
  ...
  const courses: Course[] = [
    ...
    { id: 'crs3', slug: 'yoga-foundations', title: 'Yoga Foundations', image: MEDIA.yoga, price: 4000, description: 'Build a sustainable yoga practice from scratch. Flexibility, strength, and calm.', lessons: 20, hours: 6, level: 'Beginner', partnerSlug: 'coach-nati', rating: 4.9, students: 2100, badge: 'Popular' },
    { id: 'crs4', title: 'Boxing Conditioning', slug: 'boxing-conditioning', image: MEDIA.boxing, price: 5200, description: 'Train like a fighter. Cardio, power, footwork — no sparring required.', lessons: 16, hours: 5, level: 'All levels', partnerSlug: 'coach-nati', rating: 4.8, students: 890 },
    { id: 'crs5', slug: 'womens-strength', title: 'Women\'s Strength 101', image: MEDIA.womanFit2, price: 4800, description: 'Confidently step into the weight room. Form, programming, and progressive overload.', lessons: 18, hours: 7, level: 'Beginner', partnerSlug: 'coach-nati', rating: 4.9, students: 1560 },
    { id: 'crs6', slug: 'powerlifting-101', title: 'Powerlifting 101', image: MEDIA.deadlift, price: 6400, description: 'Master squat, bench, and deadlift. Build a 300kg+ total safely.', lessons: 28, hours: 10, level: 'Intermediate', partnerSlug: 'coach-nati', rating: 4.7, students: 640 },
  ]
